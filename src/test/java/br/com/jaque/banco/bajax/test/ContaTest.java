...
public class ContaTest {
	...
	public void criaContaAtivaComSucessoCC() {
		...
		ContaCorrente conta = new ContaCorrente(agencia, numero, c1, true, limiteSaque, chequeEspecial, limiteTransferencia);
	...
	public void criaContaInativaComSucessoCC() {
		...
		ContaCorrente conta = new ContaCorrente(agencia, numero, c1, false, limiteSaque, chequeEspecial, limiteTransferencia);
	...
	public void agenciaNegativoCC() {
		...
		try {
			Conta conta = new ContaCorrente(agencia, numero, c1, true, limiteSaque, chequeEspecial, limiteTransferencia);
			fail();
		} catch (DadosInvalidosException e) {
			assertEquals("Valor inválido!", e.getMessage());
		}	
	...
	public void titularNuloCC() {
		...
		try {
			Conta conta = new ContaCorrente(agencia, numero, null, true, limiteSaque, chequeEspecial, limiteTransferencia);
			fail();
		} catch (DadosInvalidosException e) {
			assertEquals("Campos obrigatórios não devem ser nulos!", e.getMessage());
		}	
	...
	public void seContaAtivaNuloCC() {
		...
		try {
			Conta conta = new ContaCorrente(agencia, numero, c1, null, limiteSaque, chequeEspecial, limiteTransferencia);
			fail();
		} catch (DadosInvalidosException e) {
			assertEquals("Campos obrigatórios não devem ser nulos!", e.getMessage());
		}	
	...
	public void titularInativoCC() {
		...
		try {
			Conta conta = new ContaCorrente(agencia, numero, c3, true, limiteSaque, chequeEspecial, limiteTransferencia);
			fail();
		} catch (DadosInvalidosException e) {
	...
	/* Validações da operação de depósito (que funciona da mesma forma para qualquer conta) */
